...
class MainService : Service() {
	...
	private fun createForegroundNotification() {
	    ...
	    Log.d(logTag, "Attempting to start foreground service, mediaProjection: $mediaProjection")
	    try {
	...
	/*private fun createForegroundNotification() {
	    ...
	    try {
	        ...
	        Log.e(logTag, "Failed to start foreground service due to permission issue: $e")
	        // Fallback: Start without specific type or notify user to grant permission
	        startForeground(DEFAULT_NOTIFY_ID, notification)
	    }
	}*/
    /*private fun createForegroundNotification() {
