...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
		...
		("powered_by_me", "Υποστηρίζεται από εμένα"),
		...
		("Set shared password", "Ορισμός κοινόχρηστου κωδικού"),
		("Exist in", "Υπάρχει σε"),
		("Read-only", "Μόνο ανάγνωση"),
		("Read/Write", "Ανάγνωση/Εγγραφή"),
		("Full Control", "Πλήρης Έλεγχος"),
		("share_warning_tip", "Συμβουλή: Προειδοποίηση κοινής χρήσης"),
		("Everyone", "Όλοι"),
		("ab_web_console_tip", "Συμβουλή: Κονσόλα ιστού βιβλίου διευθύνσεων"),
		("allow-only-conn-window-open-tip", "Συμβουλή: Επιτρέψτε μόνο τη σύνδεση με ανοιχτό παράθυρο"),
		("no_need_privacy_mode_no_physical_displays_tip", "Συμβουλή: Δεν χρειάζεται λειτουργία απορρήτου χωρίς φυσικές οθόνες"),
		("Follow remote cursor", "Ακολουθήστε τον απομακρυσμένο δρομέα"),
		("Follow remote window focus", "Ακολουθήστε την εστίαση απομακρυσμένου παραθύρου"),
		("default_proxy_tip", "Συμβουλή: Προεπιλεγμένος διακομιστής μεσολάβησης"),
		("no_audio_input_device_tip", "Συμβουλή: Δεν υπάρχει συσκευή εισόδου ήχου"),
		("Incoming", "Εισερχόμενα"),
		("Outgoing", "Εξερχόμενα"),
		("Clear Wayland screen selection", "Εκκαθάριση επιλογής οθόνης Wayland"),
		("clear_Wayland_screen_selection_tip", "Συμβουλή: Εκκαθάριση επιλογής οθόνης Wayland"),
		("confirm_clear_Wayland_screen_selection_tip", "Συμβουλή: Επιβεβαιώστε την εκκαθάριση επιλογής οθόνης Wayland"),
		("android_new_voice_call_tip", "Συμβουλή: Νέα φωνητική κλήση Android"),
		("texture_render_tip", "Συμβουλή: Απόδοση υφής"),
		("Use texture rendering", "Χρησιμοποιήστε απόδοση υφής"),
		("Floating window", "Κινητό παράθυρο"),
		("floating_window_tip", "Συμβουλή: Κινητό παράθυρο"),
		("Keep screen on", "Διατήρηση οθόνης ενεργοποιημένη"),
		("Never", "Ποτέ"),
		("During controlled", "Κατά τη διάρκεια ελέγχου"),
		("During service is on", "Όσο είναι ενεργή η υπηρεσία"),
		("Capture screen using DirectX", "Λήψη οθόνης με χρήση DirectX"),
		("enable-bot-tip", "Συμβουλή: Ενεργοποίηση ρομπότ"),
		("enable-bot-desc", "Ενεργοποιήστε το ρομπότ Telegram για αυτοματοποίηση εργασιών."),
