...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("clear_Wayland_screen_selection_tip", "Seçilen Wayland ekranını temizle."),
        ("confirm_clear_Wayland_screen_selection_tip", "Wayland ekran seçimlerini temizlemek istediğinizi onaylayın."),
        ...
        ("web_id_input_tip", "ID, doğrudan IP veya bağlantı noktası ile birlikte girin."),
        ("Download", "İndir"),
