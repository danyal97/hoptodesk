...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("powered_by_me", "Didukung oleh HopToDesk"),
        ...
        ("You will need to confirm the 2FA on the secondary device with you when trying to connect to this desktop.", "Anda perlu mengonfirmasi 2FA di perangkat sekunder bersama Anda saat mencoba terhubung ke desktop ini."),
