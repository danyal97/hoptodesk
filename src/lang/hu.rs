...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Privacy Statement", "Adatvédelmi nyilatkozat"),        ("Privacy Statement", ""),
        ("Mute", "Némítás"),
        ...
        ("verify_rustdesk_password_tip", "HopToDesk jelszó megerősítése"),
        ...
        ("scam_text1", "Ha olyan valakivel beszél telefonon, akit NEM ISMER, akiben NEM BÍZIK MEG, és aki arra kéri, hogy használja a HopToDesket és indítsa el a szolgáltatást, ne folytassa, és azonnal tegye le a telefont."),
        ...
        ("powered_by_me", "Üzemeltető: HopToDesk"),
