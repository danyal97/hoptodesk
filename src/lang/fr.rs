...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("clear_Wayland_screen_selection_tip", "Cette action supprimera toute sélection d'écran actuelle."),
        ("confirm_clear_Wayland_screen_selection_tip", "Êtes-vous sûr de vouloir effacer la sélection d'écran ?"),
        ...
        ("web_id_input_tip", "Entrez votre identifiant web."),
        ("Download", "Télécharger"),
        ("Upload folder", "Télécharger le dossier"),
        ("Upload files", "Télécharger des fichiers"),
        ("Clipboard is synchronized", "Le presse-papiers est synchronisé"),
