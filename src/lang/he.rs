...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("clear_Wayland_screen_selection_tip", "טיפ לניקוי בחירת המסך של Wayland"),
        ("confirm_clear_Wayland_screen_selection_tip", "אשר את ניקוי בחירת המסך של Wayland"),
        ...
        ("floating_window_tip", "טיפ עבור חלון צף"),
        ("Keep screen on", "שמור את המסך דלוק"),
        ("Never", "לעולם לא"),
        ("During controlled", "במהלך שליטה"),
        ("During service is on", "במהלך שהשירות פועל"),
        ("Capture screen using DirectX", "תפוס את המסך באמצעות DirectX"),
        ("Back", "חזור"),
        ("Apps", "אפליקציות"),
        ("Volume up", "גביר עוצמת קול"),
        ...
        ("Send clipboard keystrokes", "שלח הקלדות מהלוח"),
        ("network_error_tip", "טיפ עבור שגיאת רשת"),
        ("Unlock with PIN", "פתח עם קוד PIN"),
        ("Requires at least {} characters", "דורש לפחות {} תווים"),
        ("Wrong PIN", "קוד PIN שגוי"),
        ("Set PIN", "הגדר קוד PIN"),
        ...
        ("Authenticate", "אמת"),
        ("web_id_input_tip", "טיפ עבור הזנת ID"),
        ("Download", "הורדה"),
        ("Upload folder", "העלאת תיקייה"),
        ("Upload files", "העלאת קבצים"),
        ("Clipboard is synchronized", "הלוח משוכפל"),
